...
import 'package:pure_music/CustomWidgets/equalizer.dart';
import 'package:pure_music/CustomWidgets/like_button.dart';
import 'package:pure_music/CustomWidgets/popup.dart';
import 'package:pure_music/CustomWidgets/seek_bar.dart';
import 'package:pure_music/CustomWidgets/snackbar.dart';
import 'package:pure_music/CustomWidgets/textinput_dialog.dart';
import 'package:pure_music/Screens/Common/song_list.dart';
import 'package:pure_music/utils/config.dart';
import 'package:pure_music/utils/dominant_color.dart';
import 'package:pure_music/utils/lyrics.dart';
...
class _PlayScreenState extends State<PlayScreen> {
  ...
  void setOffDesktopValues(List response) {
    getTemporaryDirectory().then((tempDir) async {
      final File file = File('${tempDir.path}/images/cover.jpg');
