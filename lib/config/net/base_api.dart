...
class ApiInterceptor extends InterceptorsWrapper {
  ...
  onRequest(RequestOptions options) async {
    // if(options.data['type'] == 'kuwo') {
    //   options.baseUrl = '';
    // }
    // http://www.kuwo.cn/api/www/search/searchMusicBykeyWord?key=%E5%91%A8%E6%9D%B0%E4%BC%A6&pn=1&rn=30&httpsStatus=1&reqId=904fa612-260e-11ed-a6c2-2d5a015b41b4
