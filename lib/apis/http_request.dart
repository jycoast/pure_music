...
class HttpRequest {
  ...
  Future<dynamic> get(String uri, {required Map<String, String> headers}) async {
    try {
  ...
  Future<dynamic> getResponseBody(String uri, {required Map<String, String> headers}) async {
    try {
      http.Response response = await http.get(baseUrl + uri, headers: headers);
      final statusCode = response.statusCode;
      final body = response.body;
//      var result = Convert.jsonDecode(body);
  ...
  Future<dynamic> post(String uri, dynamic body, {required Map<String, String> headers}) async {
    try {
